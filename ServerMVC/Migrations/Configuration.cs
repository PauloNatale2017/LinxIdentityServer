namespace ServerMVC.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ServerMVC.Context.dbContext>
    {
        ...
        protected override void Seed(ServerMVC.Context.dbContext context)
        {
