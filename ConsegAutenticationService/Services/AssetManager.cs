...
namespace LinxServerAuthentication.Services
{
    internal class AssetManager
    {
        ...
        //constants
        //public const string HttpAssetsNamespace = "LinxServerAuthentication.Services.DefaultViewService.HttpAssets";
        //public const string FontAssetsNamespace = HttpAssetsNamespace + ".libs.bootstrap.fonts";

        public const string PageAssetsNamespace = "LinxServerAuthentication.Services.DefaultViewService.PageAssets";
